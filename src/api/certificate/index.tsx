...
const CERTIFICATE_API = {
  ...
  //   axiosClient.put(
  //     `${END_POINTS.CERTIFICATE}?certificateID=${params.certificateID}&certificateName=${params.certificateName}&certificateLink=${params.certificateLink}&blogPhoto=${params.blogPhoto}&link=${params.link}`,
  //   ),
  UPDATE_CERTIFICATE: (params: UpdateCertificateTypes) => {
    return axiosClient.put(END_POINTS.UPDATE_CERTIFICATE, params);
  },
  DELETE_CERTIFICATE: (certificateID: string) => axiosClient.delete(`${END_POINTS.CERTIFICATE}/certificate?foo=${certificateID}`),
};
